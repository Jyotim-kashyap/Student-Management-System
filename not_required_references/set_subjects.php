                    ...
                    <form class="form-sample" action="add_subs.php" method="GET">
                      ...
                      <div class="col-md-3">
                        <div class="form-group row m-0 p-0">
                          ...
                          <div class="col-sm-8">
                            ...
                            <select required class="form-control font-weight-bolder" name="d_id" id="department" onclick="fetch(this.value)">
                            <?php 
                      ...
                      <div class="col-md-3">
                        <div class="form-group row">
                          <label class="col-3 col-form-label">Batch</label>
                          <div class="col-8 m-0 p-0">
                          <select required class="form-control" name="b_id" id="batch" onclick="fetchem(this.value)">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive table-sm">
                    <table class="table table-hover">
                      <thead>
                        ...
                        <th class="text-center font-weight-bolder text-info px-0">Is Practical</th>
                  ...
                  <td class="align-middle text-center">
                    ...
                    <td class="project-actions align-middle text-center">
                        ...
                        <button class="btn btn-sm btn-inverse-info btn-fw" data-toggle="modal" data-target="#editBatch<?= $f['b_id']; ?>">Edit</button>
                          </div>
                              ...
                              <form action="" method="post">
                                <?php 
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="c" name="s_tmark" value="<?=$row3['sub_mtheory'];?>">
                                  </div>
                                  <div class="form-group">
